...
# 校验邮箱  "^[\w]+@[\w]+\.[\w]+$"
v = re.match("^[\w]+@[\w]+\.[\w]+$","jdfzfjc@163.com")
print(v)
# 非0开头的数[^0][0-9]*
v = re.match(r"[^0][0-9]*","20")
print(v)
# 允许2位小数
v = re.match(r"([0]+\.\d\d)|([^0][0-9]*\.\d\d)","1.12")
print(v)
# 允许汉字英文和数字，数字不能再最前（汉字：^[\u4e00-\u9fa5]{0,}$）
v = re.match(r"[^0-9][\u4e00-\u9fa50-9a-zA-Z]*","家1a")
print(v)
# 固定电话
v = re.match(r"[0][0-9]{3}-[0-9]{8}","0431-87831636")
print(v)
# 身份证号
v = re.match("[^0][0-9]{17}|[^0][0-9]{16}X","14020220010919352X")
print(v)